...
public sealed unsafe partial class InventoryHooks
{
    ...
    /*
    private Hook<UIModule.Delegates.OpenInventory>? _openInventoryHook;
    private Hook<HandleInventoryEventDelegate>? _handleInventoryEventHook;
    private Hook<RaptureAtkModule.Delegates.OpenAddon>? _openAddonHook;
    */
